...
LED_DRIVER_HOST = '10.3.10.56' # Set this to the address of the raspberry pi with the LEDs attached
...
def main():
    ...
    bytes = input_stream.read_bytes(BUFFER_SIZE)
    while bytes:
        buf = numpy.frombuffer(bytes, dtype=numpy.int8)
